    ...
    <form @submit.prevent="handleRegister" novalidate>
      ...
      <div class="mb-3">
        ...
        <div class="input-group-custom" :class="{ 'has-error': validationErrors.email }">
          ...
          <!-- Đổi placeholder name@example.com để đồng bộ với form đăng nhập -->
<input v-model="form.email" type="email" class="form-control-custom" placeholder="Nhập email của bạn" maxlength="50" />
        </div>
      ...
      <!-- Việt hóa chữ Loading và tên nút -->
    ...
    <div class="text-center mt-4 pt-2 border-top">
      <p class="footer-link m-0">
        <!-- Đổi text tiếng Anh -->
        Đã có tài khoản? <router-link to="/login" class="text-dark-blue fw-semibold decoration-none">Đăng nhập ngay</router-link>
      </p>
    </div>
  </div>
</template>
