  ...
  <div class="auth-card shadow-lg border-0 bg-white">
    ...
    <form @submit.prevent="handleLogin" novalidate>
      <div class="mb-3">
        ...
        >
          <span class="input-icon">
            ...
            >
              <path
                d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741zM1 11.105l4.708-2.897L1 5.383z"
              />
            </svg>
          </span>
          <input
      ...
      <div class="mb-3">
        ...
        >
          ...
          <span class="password-toggle" @click="showPassword = !showPassword">
            ...
            >
              ...
              />
              <path
                d="M5.525 7.646a2.5 2.5 0 0 0 2.829 2.829l-2.83-2.829zm4.95.708-2.829-2.83a2.5 2.5 0 0 0 2.829 2.83zm-1.1 1.1a3.5 3.5 0 0 1-4.95-4.95l4.95 4.95zM0 1.146l4 .4 4-4-4-4-4 4 4 4z"
              />
            </svg>
            <svg
              v-else
        ...
        <span class="field-error-text" v-if="validationErrors.password">{{
      ...
      <div
        v-if="errorMessage"
        class="alert alert-danger-custom text-center py-2 mb-3"
        role="alert"
      >
        {{ errorMessage }}
      </div>
      ...
      <button
        type="submit"
        class="btn-secure-login w-100 mt-2 d-flex align-items-center justify-content-center"
        :disabled="loading"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
