...
const openImagePreview = (item: InventoryLotListResponse) => {
        ...
        <table>
          ...
          <tbody>
            <tr v-if="store.loadingList">
              <td colspan="10" class="state-row">Đang tải danh sách lô...</td>
            </tr>

            <tr v-else-if="store.lots.length === 0">
              <td colspan="10" class="state-row">Không có lô hàng phù hợp.</td>
            </tr>
